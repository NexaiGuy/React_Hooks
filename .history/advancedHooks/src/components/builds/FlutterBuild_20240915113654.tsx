  ...
  return (
    <Wrapper ref={ref} {...bind}>
      ...
      >
        ...
        <img
          className="man"
          src="../compone/images/components/flutter/man.svg"
          style={{
            transform: `
        ...
        <img
          ...
          src="../compone/images/components/flutter/iphone.png"
          style={{
            transform: `
          translateX(${centerX / 2.5}px)
          translateY(${centerY / 2.5}px)
        ...
        <img
          ...
          src="../compone/images/components/flutter/pixel4.png"
          style={{
            transform: `
        ...
        <img
          ...
          src="../compone/images/components/flutter/background3.svg"
          style={{
            transform: `
          translateX(${centerX / 5}px)
          translateY(${centerY / 5}px)
        ...
        <img
          ...
          src="../compone/images/components/flutter/background2.svg"
          style={{
            transform: `
          translateX(${centerX / 6}px)
          translateY(${centerY / 6}px)
        ...
        <img
          ...
          src="../compone/images/components/flutter/background1.svg"
          style={{
            transform: `
